...
frappe.provide('frappe.vote'); // create a namespace within the Frappe instance
//format date
frappe.vote.ExportTool = class { // create a glue class, wich will manage your Vue instance
    constructor({ parent }) {
        this.$parent = $(parent);
